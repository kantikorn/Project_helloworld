...
### ❗ ก่อนอื่น ต้องมีพื้นฐาน Basic git control มาก่อน เช่น pull commit push 



### 📝✅เเต่ถ้าไม่มี จะเเนะนำคำสั่งที่ใช้สำหรับการทำ commit pull push ของการทำ โปรเจ็ค CI CD นี้ เบื้องต้นให้ครับ

>## 🟧 git pull
##### คำสั่ง git pull ใช้เพื่อดึงการเปลี่ยนแปลงล่าสุดจาก remote repository (เช่น GitHub, GitLab) มายัง local repository ของคุณ โดยคำสั่งนี้จะทำการ merge การเปลี่ยนแปลงเหล่านั้นกับ branch ปัจจุบันที่คุณกำลังทำงานอยู่

>## 🟩 git commit
##### คำสั่ง git commit ใช้เพื่อบันทึก (save) การเปลี่ยนแปลงที่คุณได้ทำไว้ใน working directory ไปยัง local repository โดยแต่ละครั้งที่คุณ commit คุณจะต้องใส่ข้อความ (message) ที่อธิบายถึงการเปลี่ยนแปลงที่คุณทำไป

>## 🟦 git push
##### คำสั่ง git push ใช้เพื่อส่ง (upload) การเปลี่ยนแปลงจาก local repository ของคุณไปยัง remote repository โดยปกติจะส่งการเปลี่ยนแปลงใน branch ที่คุณกำลังทำงานอยู่
